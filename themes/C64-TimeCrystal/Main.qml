...
Rectangle {
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Misc/CBMBackground-TimeCrystal1.png"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Misc/CBMAvatar-TimeCrystal.svg"
