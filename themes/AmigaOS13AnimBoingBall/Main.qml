...
Rectangle {
    ...
    property string borderimage : "AmigaOSBackground.gif"
    ...
    property string cbmavatar : "AmigaOSAvatarOLD.svg"
    ...
    property string usernametextboxcolor : amigawhite
    ...
    property string passwordtextboxcolor : amigawhite
    ...
    Image {
        ...
        anchors.verticalCenterOffset: -90  // up/down
        anchors.horizontalCenterOffset: -40   // left/right
