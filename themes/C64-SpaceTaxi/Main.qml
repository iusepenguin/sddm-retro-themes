...
Rectangle {
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Misc/CBMBackground-City2.png"
    ...
    property string dialogboximage: "MasterAssets/Windows/Solid/CBMWindow-SolidBlackDarkGrey.svg"
    ...
    property int avatartoppadding: fsize * 4.0
    property string cbmavatar: "MasterAssets/Avatars/Misc/CBMAvatar-SpaceTaxi.svg"
    ...
    property string restartbuttoncolor: c64yellow
    ...
    property string shutdownbuttoncolor: c64yellow
    ...
    property string usernamecolor: c64red
    ...
    property string passwordcolor: c64red
    ...
    property string comboboxfocuscolor: c64yellow
