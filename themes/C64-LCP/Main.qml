...
Rectangle {
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Misc/CBMBackground-LCP.png"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Misc/CBMAvatar-LCPguy2.svg"
