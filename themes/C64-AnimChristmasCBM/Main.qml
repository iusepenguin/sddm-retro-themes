...
Rectangle {
    ...
    property int headertexttoppadding: 100 // fsize * cbmheadertexttoppadding
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Animated/CBMBackground-Snow.gif"
    ...
    property string dialogboxtextcolor: c64yellow

    property int dialogboxtextsize: fsize
    property string dialogboximage: "MasterAssets/Windows/CBMWindow-White.svg"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Logos/MultiColor/CBMAvatar-Snow.svg"
    ...
    property string loginbuttonup: "MasterAssets/Buttons/Login/Up/CBMLoginButtonUp-Green.svg"
    property string loginbuttondown: "MasterAssets/Buttons/Login/Down/CBMLoginButtonDown-Green.svg"
    property string loginbuttonhover: "MasterAssets/Buttons/Login/Hover/CBMLoginButtonHover-Green.svg"
    ...
    property string usernamecolor: c64lightgreen
    ...
    property string passwordcolor: c64lightgreen
    ...
    property string comboboxcolor: c64green
    property string comboboxbordercolor: c64green
    property string comboboxhovercolor: c64green
    property string comboboxfocuscolor: c64black
    property string comboboxtextcolor: c64blue
    property string comboboxmenucolor: c64green
