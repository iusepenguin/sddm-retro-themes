...
Rectangle {
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Animated/CBMBackground-SnowTown.gif"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Animated/CBMAvatar-Frosty.gif"
