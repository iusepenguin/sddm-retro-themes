...
Rectangle {
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Animated/CBMBackground-AnimHalloween.gif"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Animated/CBMAvatar-Jack-O-Lantern.gif"
