...
Rectangle {
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Animated/CBMBackground-ImpossibleMission.gif"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Animated/CBMAvatar-TapeDrive.gif"
