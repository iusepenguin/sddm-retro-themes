...
Rectangle {
    ...
    property string dialogboximage: "MasterAssets/Windows/Solid/CBMWindow-SolidBlackWhite-70Percent.svg"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Animated/CBMAvatar-ChristmasTree.gif"
