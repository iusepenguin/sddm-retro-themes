...
Rectangle {
    ...
    property string backgroundimg : "MasterAssets/Backgrounds/Animated/c64-blinking-cursor-magenta.gif"
    ...
    property string cbmavatar : "MasterAssets/Avatars/Animated/CBMAvatar-AnimCBMLogo2.gif"
