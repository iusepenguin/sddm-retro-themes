...
Rectangle {
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Animated/CBMBackground-LCP.gif"
    ...
    property string dialogboximage: "MasterAssets/Windows/Solid/CBMWindow-Solid-Black-DarkGrey.svg"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Animated/CBMAvatar-LCPTalk.gif"
    property int avatarwidth: defaultspritewidth + 50
