...
Rectangle {
    ...
    property string backgroundimg: "MasterAssets/Backgrounds/Misc/AtariBackground-ST.png"
    ...
    property string cbmavatar: "MasterAssets/Avatars/Misc/AtariAvatar-Bee.svg"
    ...
    property int usernametextboxtoppadding: fsize * 1.6
    property int usernametextboxwidth: fsize * 11
    property int usernametextboxheight: fsize * 1.9
    ...
    property int passwordtextboxtoppadding: fsize * 4.5
    property int passwordtextboxwidth: fsize * 11
    property int passwordtextboxheight: fsize * 1.9
    ...
    property int comboboxtoppadding: fsize * 7.5
    ...
    property int comboboxwidth: fsize * 10
